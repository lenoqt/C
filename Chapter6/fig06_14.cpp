...
int main() {
    ...
    // using {} in the vector constructor will initialize the vector with
    // only 1 element of the specified value inside the braces
    // i.e vector<int> integers1{7}; will be a vector of size 1 of value 7

    // print integers1 size and contents
    cout << "\nSize of vector integers1 is " << integers1.size()
    ...
    // use square brackets to create a lvalue
